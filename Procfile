...
celery_worker: celery -A src.celery_tasks.celery_app worker --loglevel=INFO -E --pool=asyncio
celery_beat: celery -A src.celery_tasks.celery_app beat --loglevel=INFO --pool=asyncio
